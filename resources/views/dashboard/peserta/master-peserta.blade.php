              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <center>
                      <a class="btn btn-warning btn-xs" title="Edit Data" href="{{ url('/dashboard/detail-peserta') }}/{{ $row->id }}"><span class="glyphicon glyphicon-edit"></span></a>
                        <a class="btn btn-danger btn-xs" title="Delete Data" href="{{ url('/dashboard/delete-peserta') }}/{{ $row->id }}"><span class="glyphicon glyphicon-remove"></span></a>
                      </center>
                    </td>
                  </tr>
                  @endforeach

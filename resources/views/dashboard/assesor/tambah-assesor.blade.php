                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-7 col-sm-offset-2">
                                ...
                                <form class="form-horizontal" action="{{ route('post-tambah-assesor') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="nama_assesor" class="col-sm-3 control-label">Nama Assesor</label>

                                        <div class="col-sm-9">
                                            <input name="assesor_nama" type="text" class="form-control"
                                                id="nama_assesor">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="assesor_nira" type="text" class="form-control" id="NIRA"
                                                placeholder="0"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="assesor_urutan" class="form-control select2"
                                                style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="assesor_jeniskelamin" class="form-control select2"
                                                style="width: 100%;">
                                                <option selected="selected" disabled>--Pilih--</option>

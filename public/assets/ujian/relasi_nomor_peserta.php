    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="relasi_nomor_peserta.php"><i class="fa fa-circle-o"></i> Nomor Ujian - Peserta</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1</td>
                  <td>CBT-001</td>
                  <td>012 231983989129</td>
                  <td>SURYA PALO</td>
                  <td>18 Nov 2020 | 10:00 WITA</td>
                  <td>
                    <a class="btn btn-danger btn-xs" title="Block Data" href="#"><span class="glyphicon glyphicon-ban-circle"></span></a>
                  </td>
                </tr>
                </tbody>
              </table>

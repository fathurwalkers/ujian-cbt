        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                ...
                <a class="pull-right btn btn-primary btn-sm btn-social" href="jadwal_ujian/tambah_data.php">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <a class="btn btn-warning btn-xs" title="Edit Data" href="jadwal_ujian/edit_data.php"><span class="glyphicon glyphicon-edit"></span></a>

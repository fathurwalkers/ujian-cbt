        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="../master_peserta.php" class="pull-right btn btn-warning btn-sm">
                ...
                <div class="col-sm-7 col-sm-offset-2">
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="nik" name="nik" placeholder="0" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="nip" name="nip" placeholder="0" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="pangkat" class="col-sm-3 control-label">Jabatan</label>

                      <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="pangkat" name="pangkat" placeholder="Enter ..."></textarea>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="nip" class="col-sm-3 control-label">Telepon</label>
                    ...
                    <div class="form-group">
                      <label for="urutan_assesor" class="col-sm-3 control-label">Jenis Kelamin</label>

                      <div class="col-sm-9">
                        <select class="form-control select2" style="width: 100%;" name="urutan_assesor">

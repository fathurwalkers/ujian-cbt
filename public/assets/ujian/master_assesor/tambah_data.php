        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="../master_assesor.php"><i class="fa fa-circle-o"></i> Master Assesor</a></li>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border">
                ...
                <a href="../master_assesor.php" class="pull-right btn btn-warning btn-sm">
                  ...
                  <div class="col-sm-7 col-sm-offset-2">
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="NIRA" placeholder="0" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="urutan_assesor" class="col-sm-3 control-label">Urutan Assesor</label>

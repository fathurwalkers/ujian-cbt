        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                ...
                <a class="pull-right btn btn-primary btn-sm btn-social" href="bank_soal/tambah_data.php">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1</td>
                  <td>
                    Fitri : The French homework is really hard. I don’t feel like to do it. <br>
                    Rahmat : … to help you? <br>
                    Fitri : It sounds great. Thanks, Rahmat! <br>


                    Which of the following offering expressions best fill the blank?
                  </td>
                  <td>18 Nov 2020 | 10:20 WITA</td>
                  <td>
                      <a class="btn btn-default btn-xs" title="Lihat Data" href="bank_soal/detail_data.php"><i class="fa fa-eye"></i> Detail</a>
                      <a class="btn btn-warning btn-xs" title="Edit Data" href="bank_soal/edit_data.php"><span class="glyphicon glyphicon-edit"></span></a>

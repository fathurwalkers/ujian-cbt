      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../ujian_hasil_ujian.php"><i class="fa fa-circle-o"></i> Hasil Ujian</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-sm-12" style="margin-bottom: 1.5rem;">
                  <a href="../ujian_hasil_ujian.php" class="btn btn-default btn-sm">
            ...
            <div style="margin-left: 16px; margin-right: 16px; padding-bottom: 4rem; padding-top: 2rem;">

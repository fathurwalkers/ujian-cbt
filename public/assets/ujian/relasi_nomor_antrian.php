...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Nomor Ujian - Antrian
        <small>Data Nomor Ujian - Antrian</small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                <h3 class="box-title">Relasi Data Nomor Ujian - Antrian</h3>
                <a class="pull-right btn btn-primary btn-sm btn-social" href="relasi_nomor_ujian_antrian/tambah_data.php">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>10:00 WITA</td>
                  <td>
                    <a class="btn btn-warning btn-xs" title="Edit Data" href="relasi_nomor_ujian_antrian/edit_data.php"><span class="glyphicon glyphicon-edit"></span></a>

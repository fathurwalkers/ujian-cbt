      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../relasi_nomor_antrian.php"><i class="fa fa-circle-o"></i> Nomor Ujian - Antrian</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="../relasi_nomor_antrian.php" class="pull-right btn btn-warning btn-sm">
                ...
                <div class="col-sm-7 col-sm-offset-2">
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control select2" style="width: 100%;" name="nomor_ujian">
                          <option selected="selected" disabled>--Pilih--</option>
                          <option>CBT-001</option>
                          <option>CBT-002</option>
                          <option>CBT-003</option>
                        </select>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="antrian" class="col-sm-3 control-label">Antrian</label>
                    ...
                    <div class="form-group">
                      <label for="waktu_ujian" class="col-sm-3 control-label">Waktu Ujian</label>

                      <div class="col-sm-9">
                        <div class="input-group">
                          <input type="text" class="form-control timepicker" id="waktu_ujian" name="waktu_ujian">

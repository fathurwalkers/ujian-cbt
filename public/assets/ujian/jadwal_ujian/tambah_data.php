    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../ujian_jadwal_ujian.php"><i class="fa fa-circle-o"></i> Jadwal Ujian</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <a href="../ujian_jadwal_ujian.php" class="pull-right btn btn-warning btn-sm">
                ...
                <div class="col-sm-7 col-sm-offset-2">
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="jumlah_soal" name="jumlah_soal" placeholder="0" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="estimasi_waktu" class="col-sm-3 control-label">Estimasi Waktu Ujian</label>

                      <div class="col-sm-9">
                        <div class="input-group">
                          <input type="text" class="form-control" id="estimasi_waktu" name="estimasi_waktu" placeholder="0" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                    ...
                    <div class="form-group">
                      <label for="waktu_mulai_ujian" class="col-sm-3 control-label">Waktu Mulai Ujian</label>

                      <div class="col-sm-9">
                        <div class="input-group">
                          <input type="text" class="form-control timepicker" id="waktu_mulai_ujian" name="waktu_mulai_ujian">
                    ...
                    <div class="form-group">
                      <label for="waktu_selesai_ujian" class="col-sm-3 control-label">Waktu Selesai Ujian</label>

                      <div class="col-sm-9">
                        <div class="input-group">
                          <input type="text" class="form-control timepicker" id="waktu_selesai_ujian" name="waktu_selesai_ujian">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control select2" style="width: 100%;" name="jenis_soal">

...
class BanksoalController extends Controller
{
    ...
    public function post_tambah_banksoal(Request $request)
    {
        $bank_soal = Banksoal::create([
            'soal_file' => $request->file('soal_file'),
            ...
            'soal_file1' => $request->file('soal_file1'),
            'soal_file2' => $request->file('soal_file2'),
            'soal_file3' => $request->file('soal_file3'),
            'soal_file4' => $request->file('soal_file4'),
            'soal_file5' => $request->file('soal_file5'),

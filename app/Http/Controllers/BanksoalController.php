...
class BanksoalController extends Controller
{
    ...
    public function post_tambah_banksoal(Request $request)
    {
        $bank_soal = Banksoal::create([
            'soal_file' => $request->soal_file->store('gambar', 'public'),
            ...
            'soal_file1' => $request->soal_file1->store('gambar', 'public'),
            'soal_file2' => $request->soal_file2->store('gambar', 'public'),
            'soal_file3' => $request->soal_file3->store('gambar', 'public'),
            'soal_file4' => $request->soal_file4->store('gambar', 'public'),
            'soal_file5' => $request->soal_file5->store('gambar', 'public'),
